...
import {searchPartitionByName } from "./jps"
...
export class UIExampleFactory {
  ...
  static registerRightClickMenuPopup() {
    ztoolkit.Menu.register(
      ...
      {
        tag: "menu",
        label: getString("menuitem-updatepartition"),
        children: [
          {
            tag: "menuitem",
            label: getString("menuitem-updatepartition-cas"),
  ...
  static async registerExtraColumn() {
    const field = "partition-cas";
    await Zotero.ItemTreeManager.registerColumns({
      pluginID: config.addonID,
      dataKey: field,
      label: getString(field),
      dataProvider: (item: Zotero.Item, _) => {
        return ztoolkit.ExtraField.getExtraField(item, field) || "无分区信息";
      },
    });
  }
